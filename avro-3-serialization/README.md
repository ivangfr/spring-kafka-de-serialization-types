...
- **avro-3-producer-service**
  ...
  - Run application
    ```
    ./mvnw clean package spring-boot:run --projects avro-3-serialization/avro-3-producer-service -DskipTests
    ```
...
- **avro-3-consumer-service**
  ...
  - Run application
    ```
    ./mvnw clean package spring-boot:run --projects avro-3-serialization/avro-3-consumer-service -DskipTests
    ```
