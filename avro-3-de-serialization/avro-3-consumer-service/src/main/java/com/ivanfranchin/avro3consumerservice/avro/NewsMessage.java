 ...
 */
package com.ivanfranchin.avro3consumerservice.avro;
...
public class NewsMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6645291653226639330L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"NewsMessage\",\"namespace\":\"com.ivanfranchin.avro3consumerservice.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"fromId\",\"type\":\"int\"},{\"name\":\"fromName\",\"type\":\"string\"},{\"name\":\"title\",\"type\":\"string\"}]}");
   ...
   */
  public static com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder newBuilder() {
    return new com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder();
  }
   ...
   * @return A new NewsMessage RecordBuilder
   */
  public static com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder newBuilder(com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder other) {
    if (other == null) {
      return new com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder();
    } else {
      return new com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder(other);
    }
  }
   ...
   * @return A new NewsMessage RecordBuilder
   */
  public static com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder newBuilder(com.ivanfranchin.avro3consumerservice.avro.NewsMessage other) {
    if (other == null) {
      return new com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder();
    } else {
      return new com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NewsMessage>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ivanfranchin.avro3consumerservice.avro.NewsMessage other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder setFromId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder clearFromId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder setFromName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder clearFromName() {
      fromName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder setTitle(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ivanfranchin.avro3consumerservice.avro.NewsMessage.Builder clearTitle() {
      title = null;
