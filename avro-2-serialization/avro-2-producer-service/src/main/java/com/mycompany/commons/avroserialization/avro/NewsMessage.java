 ...
 */
package com.mycompany.commons.avroserialization.avro;
...
public class NewsMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -9092388010066734291L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"NewsMessage\",\"namespace\":\"com.mycompany.commons.avroserialization.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"fromId\",\"type\":\"int\"},{\"name\":\"fromName\",\"type\":\"string\"},{\"name\":\"title\",\"type\":\"string\"}]}");
   ...
   */
  public static com.mycompany.commons.avroserialization.avro.NewsMessage.Builder newBuilder() {
    return new com.mycompany.commons.avroserialization.avro.NewsMessage.Builder();
  }
   ...
   * @return A new NewsMessage RecordBuilder
   */
  public static com.mycompany.commons.avroserialization.avro.NewsMessage.Builder newBuilder(com.mycompany.commons.avroserialization.avro.NewsMessage.Builder other) {
    return new com.mycompany.commons.avroserialization.avro.NewsMessage.Builder(other);
  }
   ...
   * @return A new NewsMessage RecordBuilder
   */
  public static com.mycompany.commons.avroserialization.avro.NewsMessage.Builder newBuilder(com.mycompany.commons.avroserialization.avro.NewsMessage other) {
    return new com.mycompany.commons.avroserialization.avro.NewsMessage.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NewsMessage>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.mycompany.commons.avroserialization.avro.NewsMessage.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.mycompany.commons.avroserialization.avro.NewsMessage other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.avroserialization.avro.NewsMessage.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.avroserialization.avro.NewsMessage.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.avroserialization.avro.NewsMessage.Builder setFromId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.avroserialization.avro.NewsMessage.Builder clearFromId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.avroserialization.avro.NewsMessage.Builder setFromName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.avroserialization.avro.NewsMessage.Builder clearFromName() {
      fromName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.avroserialization.avro.NewsMessage.Builder setTitle(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.commons.avroserialization.avro.NewsMessage.Builder clearTitle() {
      title = null;
