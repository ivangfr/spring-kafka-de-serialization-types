 ...
 */
package com.mycompany.avroproducerservice.avro;
...
public class NewsMessage extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4080005913250967844L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"NewsMessage\",\"namespace\":\"com.mycompany.avroproducerservice.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"fromId\",\"type\":\"int\"},{\"name\":\"fromName\",\"type\":\"string\"},{\"name\":\"title\",\"type\":\"string\"}]}");
   ...
   */
  public static com.mycompany.avroproducerservice.avro.NewsMessage.Builder newBuilder() {
    return new com.mycompany.avroproducerservice.avro.NewsMessage.Builder();
  }
   ...
   * @return A new NewsMessage RecordBuilder
   */
  public static com.mycompany.avroproducerservice.avro.NewsMessage.Builder newBuilder(com.mycompany.avroproducerservice.avro.NewsMessage.Builder other) {
    if (other == null) {
      return new com.mycompany.avroproducerservice.avro.NewsMessage.Builder();
    } else {
      return new com.mycompany.avroproducerservice.avro.NewsMessage.Builder(other);
    }
  }
   ...
   * @return A new NewsMessage RecordBuilder
   */
  public static com.mycompany.avroproducerservice.avro.NewsMessage.Builder newBuilder(com.mycompany.avroproducerservice.avro.NewsMessage other) {
    if (other == null) {
      return new com.mycompany.avroproducerservice.avro.NewsMessage.Builder();
    } else {
      return new com.mycompany.avroproducerservice.avro.NewsMessage.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NewsMessage>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.mycompany.avroproducerservice.avro.NewsMessage.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.mycompany.avroproducerservice.avro.NewsMessage other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.avroproducerservice.avro.NewsMessage.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.avroproducerservice.avro.NewsMessage.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.avroproducerservice.avro.NewsMessage.Builder setFromId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.avroproducerservice.avro.NewsMessage.Builder clearFromId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.avroproducerservice.avro.NewsMessage.Builder setFromName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.avroproducerservice.avro.NewsMessage.Builder clearFromName() {
      fromName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.avroproducerservice.avro.NewsMessage.Builder setTitle(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.mycompany.avroproducerservice.avro.NewsMessage.Builder clearTitle() {
      title = null;
